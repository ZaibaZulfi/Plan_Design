...
namespace Plan_Design.Steps
{
    ...
    public class Positive_TC5_PD_Error_Message_Solving_Steps
    {
        ...
        public void GivenUserEntersDataInTheSubmission_ScreenFields()
        {
            //Plan Design Name
            CustomControls.Wait();
            PropertiesCollection.ngdriver.FindElement(By.Id("ctl00_cphMain_answercontrolb1337459bb244e7989effbf59d6cb1c7_txtxb7fee7aa-ded9-4f00-a614-c205a704ca53")).SendKeys("PLAN-11");
