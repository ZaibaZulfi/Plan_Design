...
namespace Plan_Design.Steps
{
    class PageObjects
    {
        ...
        public static string Login_Screen(int which_object)
        {
            ...
            string Down_Arrow = "(//i[@class='fa fa-arrow-down fa-mx'])[194]";//(case 76 XPATH for down arrow  after completeing PD)
            ...
            string Pager_Control = "(//tr/td)[106]";//(case 85 XPATH for Pager Control)
            string Processed_Status_File = "(//i[@class='fa fa-download fa-mx'])[5]";//(case 86 XPATH for Processed_Status_File)
            string Processed_View_Detail = "(//i[@class='fa fa-arrow-circle-right fa-2x'])[5]";//(case 87 XPATH for Processed file _View_Detail)
            string Account_Name_Processed_File = "//a[text()='Computer library LLC']";//(case 88 XPATH for Account_Name_Processed_File)
            switch (which_object)
            {
